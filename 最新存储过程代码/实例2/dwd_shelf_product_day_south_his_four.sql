CREATE DEFINER=`shprocess`@`%` PROCEDURE `dwd_shelf_product_day_south_his_four`()
BEGIN
...
-- AND i.WHETHER_CLOSE = 2;  -- 0413 调整逻辑 受疫情影响，调整逻辑
...
FROM  fe_dwd.dwd_lsl_shelf_product_his_tmp_3 c
;
...
CALL sh_process.sql_log_info("dwd_shelf_product_day_south_his_four","@time_29--@time_31",@time_29,@time_31);
--  上架数量
...
CALL sh_process.sql_log_info("dwd_shelf_product_day_south_his_four","@time_34--@time_36",@time_34,@time_36);
...
CALL sh_process.sql_log_info("dwd_shelf_product_day_south_his_four","@time_40--@time_42",@time_40,@time_42);
...
SELECT DISTINCT 
        ...
        a.product_id,
		a.stat_date
FROM fe_temp.sf_product_activity_item a     -- 用fe_temp库下的同名表替换
WHERE  a.data_flag = 1
AND a.stat_date >= @start_date
AND a.stat_date < @end_date
;
SET @time_53 := CURRENT_TIMESTAMP();
CALL sh_process.sql_log_info("dwd_shelf_product_day_south_his_four","@time_51--@time_53",@time_51,@time_53);
...
CALL sh_process.sql_log_info("dwd_shelf_product_day_south_his_four","@time_57--@time_59",@time_57,@time_59);
...
CALL sh_process.sql_log_info("dwd_shelf_product_day_south_his_four","@time_68--@time_70",@time_68,@time_70);
...
CALL sh_process.sql_log_info("dwd_shelf_product_day_south_his_four","@time_73--@time_75",@time_73,@time_75);
...
CALL sh_process.sql_log_info("dwd_shelf_product_day_south_his_four","@time_78--@time_80",@time_78,@time_80);
...
CALL sh_process.sql_log_info("dwd_shelf_product_day_south_his_four","@time_83--@time_85",@time_83,@time_85);
-- 执行记录日志
...
@stime);
-- 记录表的数据量
call sh_process.dwd_count_process_aim_table_size('fe_dwd.dwd_shelf_product_day_east_his','dwd_shelf_product_day_south_his_four','李世龙');
call sh_process.dwd_count_process_aim_table_size('fe_dwd.dwd_shelf_product_day_west_his','dwd_shelf_product_day_south_his_four','李世龙');
call sh_process.dwd_count_process_aim_table_size('fe_dwd.dwd_shelf_product_day_north_his','dwd_shelf_product_day_south_his_four','李世龙');
call sh_process.dwd_count_process_aim_table_size('fe_dwd.dwd_shelf_product_day_south_his','dwd_shelf_product_day_south_his_four','李世龙');
