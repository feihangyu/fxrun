CREATE DEFINER=`feprocess`@`%` PROCEDURE `prc_d_ma_unsalable`()
BEGIN
 ...
 DELETE FROM feods.d_ma_unsalable WHERE sdate = @sdate;
  ## 今日统计昨日严重滞销品
INSERT INTO feods.d_ma_unsalable (sdate, business_name, GMV, QTY, DISCOUNT_AMOUNT,SALE_SHELF_NUM,on_shelf_stock_qty,on_shelf_stock_shelf_num, pay_aoumnt)
