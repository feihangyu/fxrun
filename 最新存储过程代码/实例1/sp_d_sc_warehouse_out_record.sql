CREATE DEFINER=`feprocess`@`%` PROCEDURE `sp_d_sc_warehouse_out_record`(in_sdate DATE)
...
SET @sdate1 = in_sdate;
DELETE FROM feods.d_sc_warehouse_outbound_daily WHERE sdate = @sdate1;
INSERT INTO feods.d_sc_warehouse_outbound_daily
(`sdate`,
  region_area,
  business_area,
  warehouse_number, 
...
;
# 14天出库 各类型
DELETE FROM feods.d_sc_warehouse_outbound_forteen WHERE sdate = @sdate1;
INSERT INTO feods.d_sc_warehouse_outbound_forteen
(`sdate`,
  region_area,
  business_area,
  warehouse_number, 
...
FROM feods.d_sc_warehouse_outbound_daily s
...
;
# 14天总计
DELETE FROM feods.d_sc_warehouse_outbound_forteen_total WHERE sdate = @sdate1;
INSERT INTO feods.d_sc_warehouse_outbound_forteen_total
(`sdate`,
  region_area,
  business_area,
  warehouse_number, 
