CREATE DEFINER=`shprocess`@`%` PROCEDURE `dwd_process_aim_table_for_check`(IN table_name VARCHAR(128),IN column1 VARCHAR(64),IN column2 VARCHAR(64),IN column3 VARCHAR(64),IN column4 VARCHAR(64),IN where_condition VARCHAR(256),IN maintainer VARCHAR(32))
BEGIN
